...
<fieldset class="fields">
	...
	<?php esc_html_e('Sendinblue', 'mailin_i18n' ); ?>
		...
		<?php esc_html_e('http://www.Sendinblue.com/', 'mailin_i18n' ); ?></a></p>
		</div>
...
<label"> <?php esc_html_e('- You should have a Sendinblue account. You can create a free account here:', 'mailin_i18n' ); ?> <a target="_blank" href="<?php esc_html_e('https://www.Sendinblue.com/?r=wporg', 'mailin_i18n' ); ?>">&nbsp;<?php esc_html_e('http://www.Sendinblue.com/', 'mailin_i18n' ); ?></a><br></label"></fieldset>
</div>
